...
You can use initializers to inject the AuthorizationService. All you need to do is for your class to implement `ZfcRbac\Service\AuthorizationServiceAwareInterface`.
