...
- [A Real World Application Part 4 - Only admins have the menu item for managing the posts](/docs/07.%20Cookbook.md#user-content-a-real-world-application-part-4---checking-permissions-in-the-view)
...
* Back to [the Using the Authorization Service](/docs/06.%20Using%20the%20Authorization%20Service.md)
