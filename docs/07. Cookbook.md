...
- [A Real World Application Part 3 - But Admins can delete everything](/docs/07.%20Cookbook.md#a-real-world-application-part-3---but-admins-can-delete-everything)
...
## A Real World Example Part 2 - Only delete your own Posts
