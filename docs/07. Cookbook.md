...
[Assetic](https://github.com/widmogrod/zf2-assetic-module) breaks when a `Guard` returns unauthorized. You can fix this by modifying your `module.config.php` to the following:
