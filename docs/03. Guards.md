...
![Zend Framework workflow without guards](/docs/images/workflow-without-guards.png)

And here is a simple workflow with route guards:

![Zend Framework workflow without guards](/docs/images/workflow-with-guards.png)
