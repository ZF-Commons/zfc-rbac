...
<a name="checking-permissions-in-a-controller"></a>In a controller :
...
<a name="checking-permissions-in-a-view"></a>In a view :
...
* Continue to [the **Cookbook**](/docs/07.%20Cookbook.md)
* Back to [the Strategies](/docs/05.%20Strategies.md)
