...
ZfcRbac is shipped with a `ZfcRbac\Factory\AuthorizationServiceDelegator` [delegator factory]
...
The delegator factory is registered by default, and you just have to add your classes to the right delegator :
